...
const convertToIntensityInteger = (intensity) => (typeof intensity == "number" && intensity >= 0) ? constants.Intensities[(intensity < 1) ? 0 : (intensity < 4.5) ? Math.round(intensity) : (intensity < 5) ? 5 : (intensity < 5.5) ? 6 : (intensity < 6) ? 7 : (intensity < 6.5) ? 8 : 9] : null;
